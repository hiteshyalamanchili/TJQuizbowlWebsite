...
<head>
    ...
    <link href="../memberPages/collapsiblePanel.css" rel="stylesheet" type="text/css">
    ...
    echo "<li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Current Members</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="panel panel-primary">
                            ...
                            * An active member is defined as a TJ student who has accumulated twenty or more points in the current academic year.
                                <div class="row">
                                <div class="table-responsive col-lg-3 col-md-6">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                <th>Seniors</th>
                                        ...
                                        <tbody>
                                            <?php
    $query = mysql_query("SELECT ID,fname,lname,points FROM $mySQL_users WHERE grade=12 AND points >= 20 ORDER BY lname ASC");
                    ...
                    echo "</td></tr>";
                                ...
                                <div class="table-responsive col-lg-3 col-md-6">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php
    $query = mysql_query("SELECT ID,fname,lname,points FROM $mySQL_users WHERE grade=11 AND points >= 20 ORDER BY lname ASC");
			if(mysql_num_rows($query) != 0)
			{
				while(($r = mysql_fetch_assoc($query)) !== false)
				{
                    ...
                    echo "</td></tr>";
                                ...
                                <div class="table-responsive col-lg-3 col-md-6">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php
    $query = mysql_query("SELECT ID,fname,lname,points FROM $mySQL_users WHERE grade=10 AND points >= 20 ORDER BY lname ASC");
			if(mysql_num_rows($query) != 0)
			{
				while(($r = mysql_fetch_assoc($query)) !== false)
				{
                    ...
                    echo "</td></tr>";
                                ...
                                <div class="table-responsive col-lg-3 col-md-6">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php
    $query = mysql_query("SELECT ID,fname,lname,points FROM $mySQL_users WHERE grade=9 AND points >= 20 ORDER BY lname ASC");
			if(mysql_num_rows($query) != 0)
			{
				while(($r = mysql_fetch_assoc($query)) !== false)
				{
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-6">
                        <div class="panel panel-info">
                            <div class="panel-heading">
             <h4 class="panel-title">
        <a data-toggle="collapse" data-target="#collapseinactive" 
           href="#collapseinactive">
          Inactive Members
        </a>
      </h4>     
                            </div>
                            <div id="collapseinactive" class="panel-collapse collapse in">
                            <div class="panel-body">
                            * An inactive members is defined as someone who has accumulated less than twenty points in the current academic year.
                                <div class="row">
                                <div class="table-responsive col-lg-3 col-md-6">
                                    <table class="table">
                                        <thead>
