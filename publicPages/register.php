...
<head>
    ...
    <title>TJHSST Quizbowl Register</title>
...
if(isset($_SESSION['auth']) && $_SESSION['auth'] == true) { }
    ...
    echo "<li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Register for the Team!</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
  ...
  Error adding user.
                ...
                if(isset($_GET['error']) && $_GET['error'] == 'baduname') {
                    ...
                    <div class=\"col-lg-12 col-md-12\">
                        <div class=\"alert alert-danger alert-dismissible\" role=\"alert\">
  <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>
  Error adding user - Username already exists.  Please use your TJ username.
</div>
                    </div>
                </div>";
                }                 
                if(isset($_GET['error']) && $_GET['error'] == 'baduname2') {
                    ...
                    <div class=\"col-lg-12 col-md-12\">
                        <div class=\"alert alert-danger alert-dismissible\" role=\"alert\">
  <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>
  Error adding user - TJ usernames contain only letters and numbers.
</div>
                    </div>
                </div>";
                }                   
                if(isset($_GET['error']) && $_GET['error'] == 'badname') {
                    ...
                    <div class=\"col-lg-12 col-md-12\">
                        <div class=\"alert alert-danger alert-dismissible\" role=\"alert\">
  <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>
  Error adding user - First and last names usually contain only letters.
</div>
                    </div>
                </div>";
                }                 
                if(isset($_GET['error']) && $_GET['error'] == 'bademail') {
                    ...
                    <div class=\"col-lg-12 col-md-12\">
                        <div class=\"alert alert-danger alert-dismissible\" role=\"alert\">
  <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>
  Error adding user - The email entered is invalid.
</div>
                    </div>
                </div>";
                }
                if(isset($_GET['error']) && $_GET['error'] == 'blank') {
                    ...
                    <div class=\"col-lg-12 col-md-12\">
                        <div class=\"alert alert-danger alert-dismissible\" role=\"alert\">
  <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>
  Error adding user - Please do not leave anything blank.
</div>
                    </div>
                </div>";
                }
  ...
  <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>
  The user has been added. Please log in with the default password (\"default\"). After logging in, please remember to <strong>immediately</strong> change your password through the \"Change Preferences\" option in the upper right-hand corner.
</div>
                    </div>
                </div>";
                }                
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <form action="../loginPages/registerExecute.php" method="post" role="form">
                                            <div class="form-group">
                                                <label>Username</label>
                                                <input name="username" class="form-control">
                                                <p class="help-block">Use your TJ login name if you are a TJ student (2016jdoe); Wilmington Charter collaborators, please use CSW followed by your first initial and last name (e.g., CSWvwadhwa)</p>
                                            </div>
                                            <div class="form-group">
                                                <label>First Name</label>
                                                <input name="fname" class="form-control" placeholder="e.g. John">
                                            </div>
                                            <div class="form-group">
