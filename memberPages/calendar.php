...
if(isset($_SESSION['auth']) && $_SESSION['auth'] == true) { }
    ...
    echo "<li>
        ...
        <div id="page-wrapper">
            ...
            <iframe src="https://www.google.com/calendar/embed?showPrint=0&amp;showTabs=0&amp;showCalendars=0&amp;showTz=0&amp;height=600&amp;wkst=1&amp;bgcolor=%23ffffff&amp;src=tjhsstquizbowl%40gmail.com&amp;color=%2329527A&amp;ctz=America%2FNew_York" style="border-width:0" width="800" height="600" frameborder="0" scrolling="no"></iframe>
        </div>
        <div class="hidden-lg hidden-md hidden-sm visible-xs-block">
            <iframe src="https://www.google.com/calendar/embed?mode=AGENDA&amp;showPrint=0&amp;showTabs=0&amp;showCalendars=0&amp;showTz=0&amp;height=400&amp;wkst=1&amp;bgcolor=%23ffffff&amp;src=tjhsstquizbowl%40gmail.com&amp;color=%2329527A&amp;ctz=America%2FNew_York" style="border-width:0" width="300" height="400" frameborder="0" scrolling="no"></iframe>
        </div>
                    </div>
                </div>
            </div>
