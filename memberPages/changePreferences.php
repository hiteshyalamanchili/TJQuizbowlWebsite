...
<head>
    ...
    <title>TJHSST Quizbowl Preferences</title>
                ...
                ?>
                    ...
                    if(isset($_SESSION['auth']) && $_SESSION['auth'] == true) {                        
                        echo "<ul class=\"dropdown-menu dropdown-user\">
                            ...
                            <li><a href=\"#\"><i class=\"fa fa-gear fa-fw\"></i> Change Preferences</a>
                            </li>
                            <li class=\"divider\"></li>
...
if(isset($_SESSION['auth']) && $_SESSION['auth'] == true) { }
    ...
    echo "<li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <!-- /.row -->
                <?php
                if(isset($_GET['error']) && $_GET['error'] == 'changepref') {
                    echo "<div class=\"row\">
                    <div class=\"col-lg-12 col-md-12\">
                        <div class=\"alert alert-danger alert-dismissible\" role=\"alert\">
  <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>
  Error changing your preferences.
</div>
                    </div>
                </div>";
                }                   
                if(isset($_GET['success']) && $_GET['success'] == 'changepref') {
                    echo "<div class=\"row\">
                    <div class=\"col-lg-12 col-md-12\">
                        <div class=\"alert alert-success alert-dismissible\" role=\"alert\">
  <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>
  Your preferences have been successfully changed.
</div>
                    </div>
                </div>";
                }
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <form action="../loginPages/user_changePreferencesExecute.php" method="post" role="form">
                                            <div class="form-group">
                                                <label>First Name</label>
                                                <input name="fname" class="form-control" disabled=true value="<?php echo $_SESSION['fname']; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label>Last Name</label>
                                                <input name="lname" class="form-control" disabled=true value="<?php echo $_SESSION['lname']; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label>E-mail</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="grade" class="form-control">
                                                    <option <?php if ($_SESSION['grade']== '9') {echo "selected=\"selected\"";}?>>9</option>
                                                    <option <?php if ($_SESSION['grade']== '10') {echo "selected=\"selected\"";}?>>10</option>
                                                    <option <?php if ($_SESSION['grade']== '11') {echo "selected=\"selected\"";}?>>11</option>
                                                    <option <?php if ($_SESSION['grade']== '12') {echo "selected=\"selected\"";}?>>12</option>
                                                    <option>Alum</option>
                                            ...
                                            <button type="submit" value="Update Information" class="btn btn-default">Submit </button>
                                            <div class="form-group">
                                            </div>
                                        </form>
                ...
                <?php
                if(isset($_GET['error']) && $_GET['error'] == 'matchconf') {
                    echo "<div class=\"row\">
                    <div class=\"col-lg-12 col-md-12\">
                        <div class=\"alert alert-danger alert-dismissible\" role=\"alert\">
  <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>
  Error changing your password - The new and confirmed passwords did not match.
</div>
                    </div>
                </div>";
                }                 
                if(isset($_GET['error']) && $_GET['error'] == 'changepass') {
                    echo "<div class=\"row\">
                    <div class=\"col-lg-12 col-md-12\">
                        <div class=\"alert alert-danger alert-dismissible\" role=\"alert\">
  <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>
  Error changing your password.
                ...
                if(isset($_GET['success']) && $_GET['success'] == 'changepass') {
                    echo "<div class=\"row\">
                    <div class=\"col-lg-12 col-md-12\">
                        <div class=\"alert alert-success alert-dismissible\" role=\"alert\">
  <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <form action="../loginPages/user_changePasswordExecute.php" method="post" role="form">
                                            <div class="form-group">
                                            ...
                                            <button type="submit" value="Change Password" class="btn btn-default">Submit</button>
